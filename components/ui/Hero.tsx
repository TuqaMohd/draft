...
export default function Hero({
  ...
  return (
    <div className="relative mb-[26px] overflow-hidden rounded-xl border border-border bg-s1 px-8 py-9 max-[640px]:px-5 max-[640px]:py-6">
      <div
        aria-hidden="true"
      ...
      <div className="relative flex flex-wrap items-end justify-between gap-6">
        <div className="max-w-[640px]">
          <h1 className="m-0 mb-2 bg-gradient-to-r from-brand-primary via-brand-accent to-sky-400 bg-clip-text font-head text-[1.75rem] font-semibold leading-tight text-transparent max-[640px]:text-[1.375rem]">
            {title}
          </h1>
